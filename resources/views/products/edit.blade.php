...
<div class="container">
    ...
    <h1 style="margin-bottom: 40px;">商品情報編集画面</h1>
    ...
    <div style="border: 1px solid #000; padding: 50px 60px; width: 900px; background-color: #fff;">
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; align-items: center; margin-bottom: 35px;">
                <label style="width: 250px; font-size: 28px; font-weight: bold;">ID.</label>
                <div style="font-size: 28px;">{{ $product->id }}.</div>
            </div>
            ...
            <div style="display: flex; align-items: flex-start; margin-bottom: 40px;">
                <label for="img_path" style="width: 250px; font-size: 28px; font-weight: bold; margin-top: 10px;">
                    商品画像
                </label>
                <div>
                    <input type="file" name="img_path" id="img_path" style="margin-bottom: 15px;">

                    @if ($product->img_path)
                        <div>
                            <img src="{{ asset($product->img_path) }}" style="width: 120px; height: auto;">
                        </div>
                    @endif
                </div>
            </div>

            <div style="display: flex; gap: 70px; margin-top: 30px;">
